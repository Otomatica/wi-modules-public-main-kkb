...
let systemCount = 6;
let campuses = ['IzmirMTK', 'IzmirDC'];
let polyAreas = ['Bornova', 'Menderes'];
let regionFilter = 'Izmir';
...
export default {
    bindings: bindings,
    designerInfo: {
        translation: 'otomaticaGraphics.mapIzmir.version',
        icon: 'map',
        size: {width: '100%', height: '100%'},
        attributes: attributes
    },
    require: {},
    controller: mapIzmirController,
