...
let systemCount = 6;
let campuses = ['Gebze', 'Izmit'];
let polyAreas = ['Gebze', 'Izmit'];
let regionFilter = 'Kocaeli';
let attributeCount = 7;
let iconShift = 0.01;
let mapOptions = {
    center: [40.8321231, 29.91372675],
    zoom: 9.75,
    options: {
        zoomSnap: 0.1,
        zoomDelta: 0.1,
...
export default {
    bindings: bindings,
    designerInfo: {
        translation: 'otomaticaGraphics.mapKocaeli.version',
        icon: 'map',
        size: {width: '100%', height: '100%'},
        attributes: attributes
    },
    require: {},
    controller: mapKocaeliController,
