...
let systemCount = 6;
let campuses = ['Dudullu', 'Mahmutbey', 'Kartal', 'Tepebasi', 'Fikirtepe', 'Maslak', 'Tspark'];
let polyAreas = ['Umraniye', 'Kartal', 'Bagcilar', 'Beyoglu', 'Kadikoy', 'Sariyer', 'Bahcelievler'];
let regionFilter = 'Istanbul';
let attributeCount = 7;
let iconShift = 0.01;
let mapOptions = {
    center: [41.19995845, 28.9647718],
    zoom: 9,
    options: {
        zoomSnap: 0.1,
        zoomDelta: 0.1,
...
export default {
    bindings: bindings,
    designerInfo: {
        translation: 'otomaticaGraphics.mapIstanbul.version',
        icon: 'map',
        size: {width: '100%', height: '100%'},
        attributes: attributes
    },
    require: {},
    controller: mapIstanbulController,
