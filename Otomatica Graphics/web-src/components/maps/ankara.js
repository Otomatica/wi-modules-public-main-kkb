...
let systemCount = 6;
let campuses = ['AnkaraDC','Baskent', 'Sogutozu', 'Cayyolu'];
let polyAreas = ['Sincan','Yenimahalle', 'Cankaya', 'Golbasi'];
let regionFilter = 'Ankara';
let attributeCount = 7;
let iconShift = 0.01;
let mapOptions = {
    center: [39.71011405, 32.35211015],
    zoom: 8.25,
    options: {
        zoomSnap: 0.1,
        zoomDelta: 0.1,
...
export default {
    bindings: bindings,
    designerInfo: {
        translation: 'otomaticaGraphics.mapAnkara.version',
        icon: 'map',
        size: {width: '100%', height: '100%'},
        attributes: attributes
    },
    require: {},
    controller: mapAnkaraController,
