...
let systemCount = 6;
let campuses = ['Adana', 'AnkaraDC','Antalya','AvrupaDC', 
				'Baskent', 'Bursa', 
				'Corlu','Cayyolu',
				'Diyarbakir', 'Dudullu',
				'Edirne', 'Erzurum', 'Eskisehir',
				'Fikirtepe',
				'Gaziantep', 'Gebze',
				'Hatay',
				'Izmir','IzmirMTK','Izmit',
				'Kartal', 'Kayseri',
				'Mahmutbey','Malatya','Manisa','Maslak','Mersin','Mugla',
				'Samsun','Sogutozu',
				'Tepebasi','Trabzon', 
				'Van',
				'Yenibosna'				
...
let polyAreas =  ['Adana', 'Antalya', 'Ankara', 'Bursa', 'Tekirdag', 'Diyarbakir', 'Istanbul', 'Edirne', 'Erzurum', 'Eskisehir', 'Gaziantep', 'Kocaeli', 'Hatay', 'Izmir', 'Kayseri', 'Malatya', 'Manisa', 'Mersin', 'Mugla', 'Samsun', 'Trabzon', 'Van'];
let attributeCount = 7;
let iconShift = 0.1;
let mapOptions = {
    center: [38.964665, 35.241610],
    zoom: 5.75,
    options: {
        zoomSnap: 0.1,
        zoomDelta: 0.1,
...
class mapTurkiyeController {
    ...
    $onInit() {
        ...
        this.coordinates = {};
        this.wiMapAttributes.city(this.highResolution).then(res => {

            res.data.features.forEach(feature => {
                this.polyAreas.includes(feature.properties.key) && this.initMarkers(feature);
...
let attributes = {
    ...
    polyTag: {type:'string', defaultValue: 'Sehir'},
...
export default {
    bindings: bindings,
    designerInfo: {
        translation: 'otomaticaGraphics.mapTurkiye.version',
        icon: 'map',
        size: {width: '100%', height: '100%'},
        attributes: attributes
    },
    require: {},
    controller: mapTurkiyeController,
